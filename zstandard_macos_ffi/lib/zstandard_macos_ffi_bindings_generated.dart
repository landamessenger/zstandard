...
/// Bindings for `src/zstandard_macos_ffi.h`.
///
/// Regenerate bindings with `dart run ffigen --config ffigen.yaml`.
///
class ZstandardMacosFfiBindings {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  ZstandardMacosFfiBindings(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  ZstandardMacosFfiBindings.fromLookup(
...
abstract class ZSTD_cParameter {
  ...
  static const int ZSTD_c_targetCBlockSize = 130;
  ...
  static const int ZSTD_c_experimentalParam11 = 1008;
  static const int ZSTD_c_experimentalParam12 = 1009;
  static const int ZSTD_c_experimentalParam13 = 1010;
  static const int ZSTD_c_experimentalParam14 = 1011;
  static const int ZSTD_c_experimentalParam15 = 1012;
  static const int ZSTD_c_experimentalParam16 = 1013;
...
abstract class ZSTD_dParameter {
  ...
  static const int ZSTD_d_experimentalParam4 = 1003;
  static const int ZSTD_d_experimentalParam5 = 1004;
  static const int ZSTD_d_experimentalParam6 = 1005;
}
